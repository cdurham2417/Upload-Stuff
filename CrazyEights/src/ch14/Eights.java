 ...
 * https://en.wikipedia.org/wiki/Crazy_Eights for basic play and scoring rules.
 */
public class Eights {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 1000; i++) {
			game = new Eights();
			game.playGame();
			if(game.one.getWins()==1)
				a++;
			if(game.two.getWins()==1)
				c++;
		}
		System.out.println("Allen: "+a+ " - "+"Chris: "+c);
	}
